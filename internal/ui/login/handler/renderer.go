...
func CreateRenderer(pathPrefix string, staticDir http.FileSystem, cookieName string, defaultLanguage language.Tag) *Renderer {
	...
	tmplMapping := map[string]string{
		...
		tmplMailVerified:        "mail_verification_done.html",
		tmplMfaInitDone:         "mfa_init_done.html",
		tmplMfaInitVerification: "mfa_init_verification.html",
		tmplMfaPrompt:           "mfa_prompt.html",
		tmplMfaVerification:     "mfa_verification.html",
		tmplPassword:            "password.html",
		tmplPasswordChange:      "password_change.html",
		tmplPasswordChangeDone:  "password_change_done.html",
		tmplPasswordInit:        "password_init.html",
		tmplPasswordInitDone:    "password_init_done.html",
		tmplPasswordResetDone:   "password_reset_done.html",
		tmplRegistration:        "registration.html",
		tmplRegistrationOrg:     "registration_org.html",
		tmplUserInit:            "user_init.html",
		tmplUserInitDone:        "user_init_done.html",
		tmplUserSelection:       "user_selection.html",
		tmplUsernameChange:      "username_change.html",
		tmplUsernameChangeDone:  "username_change_done.html",
	}

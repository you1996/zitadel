...
import { CUSTOM_INPUT_VALUE_ACCESSOR } from './input-value-accessor';



// Invalid input type. Using one of these will throw an MatInputUnsupportedTypeError.
const CONSOLE_INPUT_INVALID_TYPES = [
    'button',
    'checkbox',
    'file',
    'hidden',
...
export class InputDirective extends _InputMixinBase implements MatFormFieldControl<any>, OnChanges,
    ...
    constructor(
        ...
        @Optional() @Self() @Inject(CUSTOM_INPUT_VALUE_ACCESSOR) inputValueAccessor: any,
    ...
    protected _validateType(): any {
        if (CONSOLE_INPUT_INVALID_TYPES.indexOf(this._type) > -1) {
     ...
     * @docs-private
     */
    setDescribedByIds(ids: string[]): any {
        if (ids.length) {
